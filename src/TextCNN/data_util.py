...
def load_data_multilabel2(traning_data_path,vocab_word2index, vocab_label2index,sentence_len,training_portion=0.95):
    """
    ...
    :return:
    """
    file_object = codecs.open(traning_data_path, errors='ignore', encoding='utf-8')
